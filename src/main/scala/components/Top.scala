...
//   implicit val config = NativeConfig(32, 32) //WishboneConfig(32,32)

//   val core: Core = Module(new Core(/*req, rsp*/ new NativeRequest /*WBRequest*/,new NativeResponse /*WBResponse*/))
//   val imemAdapter = Module(new NativeAdapter() /*TilelinkAdapter()*/) //instrAdapter
//   val dmemAdapter = Module(new NativeAdapter() /*WishboneAdapter()*/) //dmemAdapter
...
//   val core: Core = Module(new Core(/*req, rsp*/ new WBRequest /*WBRequest*/,new WBResponse /*WBResponse*/)(C = true))
